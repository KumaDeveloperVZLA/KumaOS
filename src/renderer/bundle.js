(() => {
  ...
  var require_entityrefs = __commonJS({
    "node_modules/ape-ecs/src/entityrefs.js"(exports, module) {
      var EntitySet = class extends Set {
          ...
          if (!comp.hasOwnProperty(field)) {
            Object.defineProperty(comp, field, {
              ...
              set(value) {
                ...
                if (old && old !== value) {
                  comp._deleteRef(old, field, void 0);
                }
                if (value && value !== old) {
                  comp._addRef(value, field, void 0);
                }
  ...
  var require_util = __commonJS({
    "node_modules/ape-ecs/src/util.js"(exports, module) {
      ...
      var Component6 = class {
        ...
        getObject(withIds = true) {
          ...
          for (const field of fields) {
            if (this[field] !== void 0 && this[field] !== null && typeof this[field].getValue === "function") {
  ...
  var require_entity = __commonJS({
    "node_modules/ape-ecs/src/entity.js"(exports, module) {
      ...
      var Entity = class {
        ...
        getComponents(type) {
          ...
          return this.types[type] || /* @__PURE__ */ new Set();
        }
        addTag(tag) {
        ...
        addComponent(properties) {
          ...
          if (!this.types[type]) {
            this.types[type] = /* @__PURE__ */ new Set();
          }
  ...
  var require_query = __commonJS({
    "node_modules/ape-ecs/src/query.js"(exports, module) {
      ...
      var Query = class {
        ...
        refresh() {
          ...
          this.results = new Set(
            [...results].map((id) => this.world.getEntity(id)).filter((entity) => !!entity)
          );
        ...
        execute(filter) {
          ...
          this.executed = true;
          if (filter === void 0 || !filter.hasOwnProperty("updatedComponents") && !filter.hasOwnProperty("updatedValues")) {
            return this.results;
          }
          const output = [];
          for (const entity of this.results) {
  ...
  var require_componentpool = __commonJS({
    "node_modules/ape-ecs/src/componentpool.js"(exports, module) {
      var ComponentPool = class {
  ...
  var require_entitypool = __commonJS({
    "node_modules/ape-ecs/src/entitypool.js"(exports, module) {
      var Entity = require_entity();
      ...
      var System4 = class {
        ...
        subscribe(type) {
          ...
          if (!this.world.subscriptions.has(type)) {
            ...
            this.world.subscriptions.set(type, /* @__PURE__ */ new Set());
          }
    ...
    "node_modules/ape-ecs/src/world.js"(exports, module) {
      ...
      module.exports = class World {
        constructor(config) {
          ...
          this.entityReverse = {};
          this.updatedEntities = /* @__PURE__ */ new Set();
          this.componentTypes = {};
          ...
          this.refs = {};
          this.componentPool = /* @__PURE__ */ new Map();
...
${this.currentTick}, ${key}: ${cstat.active} active, ${cstat.pooled}/${cstat.target} pooled`;
        ...
        _addRef(target, entity, component, prop, sub, key, type) {
          if (!this.refs[target]) {
            this.refs[target] = /* @__PURE__ */ new Set();
          }
          ...
          if (!this.entityReverse[target].hasOwnProperty(key)) {
            this.entityReverse[target][key] = /* @__PURE__ */ new Map();
          }
        ...
        registerTags(...tags) {
          for (const tag of tags) {
            ...
            this.entitiesByComponent[tag] = /* @__PURE__ */ new Set();
            this.tags.add(tag);
          }
        }
        registerComponent(klass, spinup = 1) {
          ...
          const name4 = klass.name;
          if (this.tags.has(name4)) {
            throw new Error(`registerComponent: Tag already defined for "${name4}"`);
          } else if (this.componentTypes.hasOwnProperty(name4)) {
            throw new Error(
              `registerComponent: Component already defined for "${name4}"`
            );
          }
          this.componentTypes[name4] = klass;
          if (!klass.registered) {
          ...
          this.entitiesByComponent[name4] = /* @__PURE__ */ new Set();
          this.componentPool.set(name4, new ComponentPool(this, name4, spinup));
        }
        ...
        copyTypes(world, types) {
          for (const name4 of types) {
            if (world.tags.has(name4)) {
              this.registerTags(name4);
            } else {
              const klass = world.componentTypes[name4];
              this.componentTypes[name4] = klass;
              this.entitiesByComponent[name4] = /* @__PURE__ */ new Set();
              this.componentPool.set(name4, new ComponentPool(this, name4, 1));
            }
          }
        }
        removeEntity(id) {
        ...
        registerSystem(group, system, initParams) {
          ...
          if (!this.systems.has(group)) {
            this.systems.set(group, /* @__PURE__ */ new Set());
          }
        ...
        _addEntityComponent(name4, entity) {
          this.entitiesByComponent[name4].add(entity.id);
        }
  ...
  var require_src = __commonJS({
    "node_modules/ape-ecs/src/index.js"(exports, module) {
  ...
  var import_ape_ecs6, DEFAULT_APPS, CloudSyncSystem;
  var init_CloudSyncSystem = __esm({
    "src/renderer/ecs/systems/CloudSyncSystem.js"() {
      import_ape_ecs6 = __toESM(require_src());
      init_firebaseConfig();
      init_auth();
      init_rtdbREST();
      DEFAULT_APPS = {
      ...
      CloudSyncSystem = class extends import_ape_ecs6.System {
        init(uid) {
          this.uid = uid;
  ...
  // src/apps/browser/BrowserApp.js
  var BrowserApp_exports = {};
  __export(BrowserApp_exports, {
    mountBrowserApp: () => mountBrowserApp,
    unmountBrowserApp: () => unmountBrowserApp
  });
  ...
  // src/apps/calculator/CalculatorApp.js
  var CalculatorApp_exports = {};
  __export(CalculatorApp_exports, {
    mountCalculatorApp: () => mountCalculatorApp,
    unmountCalculatorApp: () => unmountCalculatorApp
  });
  ...
  var init_CalculatorApp = __esm({
    "src/apps/calculator/CalculatorApp.js"() {
    }
  });

  // src/apps/calendar/CalendarApp.js
  var CalendarApp_exports = {};
  __export(CalendarApp_exports, {
    mountCalendarApp: () => mountCalendarApp,
  ...
  var init_CalendarApp = __esm({
    "src/apps/calendar/CalendarApp.js"() {
    }
  });

  // src/apps/camera/CameraApp.js
  var CameraApp_exports = {};
  __export(CameraApp_exports, {
    mountCameraApp: () => mountCameraApp,
    unmountCameraApp: () => unmountCameraApp
  });
  ...
  // src/apps/clock/ClockApp.js
  var ClockApp_exports = {};
  __export(ClockApp_exports, {
    mountClockApp: () => mountClockApp,
  ...
  var ContactsApp_exports = {};
  __export(ContactsApp_exports, {
  ...
  var GalleryApp_exports = {};
  __export(GalleryApp_exports, {
    mountGalleryApp: () => mountGalleryApp,
    unmountGalleryApp: () => unmountGalleryApp
  });
  ...
  var MessagesApp_exports = {};
  __export(MessagesApp_exports, {
    mountMessagesApp: () => mountMessagesApp,
    startMessagesBackgroundSync: () => startMessagesBackgroundSync,
    unmountMessagesApp: () => unmountMessagesApp
  });
  ...
  var MESSAGES_PATH, _unsubscribeFg, _unsubscribeBg, _bgInitialized, _appMounted, _lastMsgCount;
  var init_MessagesApp = __esm({
    "src/apps/messages/MessagesApp.js"() {
      init_rtdbREST();
      init_ToastManager();
      MESSAGES_PATH = "messages/global";
      _unsubscribeFg = null;
      _unsubscribeBg = null;
  ...
  var NotesApp_exports = {};
  __export(NotesApp_exports, {
  ...
  // src/apps/phone/PhoneApp.js
  var PhoneApp_exports = {};
  __export(PhoneApp_exports, {
    mountPhoneApp: () => mountPhoneApp,
    unmountPhoneApp: () => unmountPhoneApp
  });
  function mountPhoneApp(container) {
    container.innerHTML = `
  ...
  function unmountPhoneApp(container) {
    container.innerHTML = "";
  }
  var init_PhoneApp = __esm({
    "src/apps/phone/PhoneApp.js"() {
    }
  });

  // src/apps/settings/SettingsApp.js
  var SettingsApp_exports = {};
  __export(SettingsApp_exports, {
  ...
  // src/apps/store/AppStore.js
  var AppStore_exports = {};
  __export(AppStore_exports, {
    AppStore: () => AppStore
  });
  var AppStore;
  var init_AppStore = __esm({
    "src/apps/store/AppStore.js"() {
      AppStore = class {
        constructor() {
          this.name = "AppStore";
  ...
  var StoreApp_exports = {};
  __export(StoreApp_exports, {
    mountStoreApp: () => mountStoreApp,
  ...
  async function mountStoreApp(container, uid) {
    ...
    <div class="store-app flex flex-col h-full bg-slate-900 text-white overflow-hidden">
      <div class="p-5 bg-blue-600 shadow-md z-10 flex-shrink-0 flex items-center gap-3">
         <span class="text-3xl">\u{1F6CD}\uFE0F</span>
         <div>
      ...
      <div id="store-content" class="flex-1 overflow-y-auto p-4 space-y-4">
        <div class="flex justify-center py-10"><div class="app-loading-spinner text-white/50">Cargando cat\xE1logo...</div></div>
      </div>
    </div>
  `;
    await loadCatalog();
  ...
  async function loadCatalog() {
    ...
    try {
      ...
      <div class="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center justify-between hover:bg-white/10 transition-colors">
        ...
        ${app.enabled ? `<button class="px-4 py-2 bg-white/10 text-white/50 rounded-lg text-sm font-bold cursor-not-allowed" disabled>Instalado</button>` : `<button id="install-btn-${app.id}" data-appid="${app.id}" class="install-btn px-4 py-2 bg-blue-500 hover:bg-blue-400 text-white rounded-lg text-sm font-bold shadow-lg transition-transform hover:scale-105 active:scale-95">Obtener</button>`}
      </div>
    `).join("");
  ...
  // src/renderer/shell/StatusBar.js
  ...
  // src/renderer/shell/LockScreen.js
  init_auth();
  init_index_esm();
  function mountLockScreen(root) {
    return new Promise((resolve) => {
      const lockEl = document.createElement("div");
      lockEl.id = "lock-screen";
      lockEl.className = "absolute inset-0 flex items-center justify-center z-[100] animate-fade-in";
      lockEl.style.background = "linear-gradient(135deg, #0d0d1a 0%, #1a0a2e 50%, #0a1628 100%)";
      lockEl.innerHTML = `
    ...
    `;
      ...
      toggleBtn.addEventListener("click", () => {
        ...
        toggleBtn.textContent = isSignUp ? "Already have an account? Sign in" : "Don't have an account? Create one";
        subtitleEl.textContent = isSignUp ? "Create your KumaOS account" : "Sign in to continue";
      ...
      async function _handleSubmit() {
        ...
        try {
          const auth = await getFirebaseAuth();
          const credential = isSignUp ? await createUserWithEmailAndPassword(auth, email, password) : await signInWithEmailAndPassword(auth, email, password);
  ...
  var AppManifest = class extends import_ape_ecs.Component {
  };
  ...
  // src/renderer/ecs/components/ProcessState.js
  var import_ape_ecs2 = __toESM(require_src());
  var ProcessState = class extends import_ape_ecs2.Component {
  };
  ...
  // src/renderer/shell/RecentAppsScreen.js
  var isRecentAppsOpen = false;
  var previousRecentHTML = "";
  ...
  function renderRecentApps(container, recentApps) {
  ...
  var previousDockHTML = "";
  function renderDockApps(container, apps) {
    const sorted = [...apps].sort((a, b) => (a.order ?? 99) - (b.order ?? 99));
    const appsHTML = sorted.map((app) => `
    <div
      id="dock-icon-${app.id}"
  ...
  var UIRenderSystem = class extends import_ape_ecs5.System {
    ...
    update(tick) {
      ...
      const dockApps = [];
      const recentApps = [];
      const appsMap = /* @__PURE__ */ new Map();
      for (const entity of entities) {
  ...
  // import("../../../apps/**/*/**/*") in src/renderer/ecs/systems/WindowManagerSystem.js
  var globImport_apps = __glob({
    "../../../apps/browser/BrowserApp.js": () => Promise.resolve().then(() => (init_BrowserApp(), BrowserApp_exports)),
    "../../../apps/calculator/CalculatorApp.js": () => Promise.resolve().then(() => (init_CalculatorApp(), CalculatorApp_exports)),
    "../../../apps/calendar/CalendarApp.js": () => Promise.resolve().then(() => (init_CalendarApp(), CalendarApp_exports)),
    "../../../apps/camera/CameraApp.js": () => Promise.resolve().then(() => (init_CameraApp(), CameraApp_exports)),
    "../../../apps/clock/ClockApp.js": () => Promise.resolve().then(() => (init_ClockApp(), ClockApp_exports)),
    "../../../apps/contacts/ContactsApp.js": () => Promise.resolve().then(() => (init_ContactsApp(), ContactsApp_exports)),
    "../../../apps/gallery/GalleryApp.js": () => Promise.resolve().then(() => (init_GalleryApp(), GalleryApp_exports)),
    "../../../apps/messages/MessagesApp.js": () => Promise.resolve().then(() => (init_MessagesApp(), MessagesApp_exports)),
    "../../../apps/notes/NotesApp.js": () => Promise.resolve().then(() => (init_NotesApp(), NotesApp_exports)),
    "../../../apps/phone/PhoneApp.js": () => Promise.resolve().then(() => (init_PhoneApp(), PhoneApp_exports)),
    "../../../apps/settings/SettingsApp.js": () => Promise.resolve().then(() => (init_SettingsApp(), SettingsApp_exports)),
    "../../../apps/store/AppStore.js": () => Promise.resolve().then(() => (init_AppStore(), AppStore_exports)),
    "../../../apps/store/StoreApp.js": () => Promise.resolve().then(() => (init_StoreApp(), StoreApp_exports))
  });

  // src/renderer/ecs/systems/WindowManagerSystem.js
  var LOADED_MODULES = /* @__PURE__ */ new Map();
  var WindowManagerSystem = class extends import_ape_ecs7.System {
    ...
    _createWindowShell(appId, appName, procComponent, container) {
      ...
      <div class="app-content">
         <div class="app-loading-spinner" style="display:flex;justify-content:center;align-items:center;height:100%;color:rgba(255,255,255,0.5);">Cargando m\xF3dulo...</div>
      </div>
    `;
    ...
    async _loadAndMountApp(appId, windowEl) {
      ...
      try {
        ...
        if (LOADED_MODULES.has(appId)) {
          ...
          module = await globImport_apps(`../../../apps/${appId}/${appFileName}`);
        ...
        if (typeof module[mountFnName] === "function") {
          ...
          throw new Error(`M\xE9todo ${mountFnName} no exportado.`);
        }
      } catch (err) {
        console.error(`[WindowManager] Error cargando m\xF3dulo para ${appId}:`, err);
        contentEl.innerHTML = `<div style="padding:20px;color:red;">Error de m\xF3dulo: ${err.message}</div>`;
      }
    }
    _closeWindow(appId) {
  ...
  function ecsTick(time) {
    ...
    try {
      if (ecsWorld) {
        ecsWorld.runSystems("sync");
        ecsWorld.runSystems("render");
        ecsWorld.tick();
        lastTime = time;
      }
    } catch (err) {
      console.error("[ECS tick error]", err);
      document.getElementById("kuma-root").innerHTML += `<div style="position:absolute;z-index:9999;background:red;color:white;padding:10px;font-family:monospace;font-size:12px;">
